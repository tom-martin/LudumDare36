var levels = [
	{
		entities : [
		  {type: "player", x: 0, y: -8},
		  {type: "roller", x: 0, y: -5, horizontal: true},
		  {type: "roller", x: 0, y: -3, horizontal: true},
		  {type: "block", x: 0, y: -4 },
		  {type: "finish", x: 0, y: 0},
		],
		levelTitle: null,
	...
	},
	{
		entities : [
		  ...
		  {type: "roller", x: 0, y: -5, horizontal: true},
		  {type: "roller", x: 0, y: -3, horizontal: true},
		  {type: "roller", x: 0, y: -1, horizontal: true},
		  {type: "block", x: 0, y: -4 },
		  {type: "finish", x: 0, y: 4},
		],
	...
	,
	{
		entities : [
		  ...
		  {type: "roller", x: 0, y: -5, horizontal: true},
		  {type: "roller", x: 0, y: -3, horizontal: true},
		  {type: "roller", x: 0, y: 7, horizontal: true},
		  {type: "block", x: 0, y: -4 },
		  {type: "finish", x: 0, y: 4},
		],
	...
	,
	{
		entities : [
		  ...
		  {type: "roller", x: 0, y: -5, horizontal: true},
		  {type: "roller", x: 0, y: -3, horizontal: true},
		  {type: "tree", x: 1, y: 0, horizontal: true},
		  {type: "tree", x: -1, y: 0, horizontal: true},
		  {type: "block", x: 0, y: -6 },
		  {type: "finish", x: -4, y: 2},
		],
	...
	,
	{
		entities : [
		  ...
		  {type: "roller", x: 0, y: -5, horizontal: true},
		  {type: "roller", x: 0, y: -3, horizontal: true},
		  {type: "tree", x: -1, y: 2, horizontal: true},
		  {type: "tree", x: 1, y: 2, horizontal: true},
		  {type: "tree", x: 2, y: -1, horizontal: true},
		  {type: "finish", x: 4, y: 4},
		],
	...
	,
	{
		entities : [
		  {type: "player", x: -7, y: -8},
		  {type: "block", x: -7, y: -4},
		  {type: "roller", x: -8, y: -4, horizontal: false},
		  {type: "roller", x: -6, y: -4, horizontal: false},
		  {type: "finish", x: 4, y: 3},
		  {type: "tree", x: 5, y: -2},
		  {type: "tree", x: 9, y: -2},
		  {type: "tree", x: 6, y: 1},
